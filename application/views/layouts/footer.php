...
$(document).on("submit","#form-ingreso",function(e){
    e.preventDefault();
...
$(document).on("click",".btn-view-constancia",function(){
valor_id = $(this).val();
$.ajax({
    url: base_url + "mantenimiento/VistaConstancia/view",
    type:"POST",
    dataType:"html",
    data:{Id_Titulo:valor_id},
    success:function(data){
        $("#modal-default .modal-body").html(data);
    }
});
