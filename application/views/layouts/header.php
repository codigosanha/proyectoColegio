...
<head>
    ...
    <title>COLEGIO LA ESPERANZA </title>
    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="" class="logo">
                ...
                <span class="logo-mini"><b></b>
                    <img src="<?php echo base_url()?>assets/template/dist/img/avatar5.png" width="50" height="50"class="user-image" alt="User Image">
                </span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">PROYECTO COLEGIO <b></b>
